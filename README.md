# Slicer Print Time Estimator is a generic implemenation to read remaining time to print and custom metadata embedded in the GCODE file by the slicer
...
The following has to be added in the Start G-Code (`;Slicer Info;<key>;<Displayname>;<Value>`). You can add us much metadata as you like.
