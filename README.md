...
The following has to be added in the Start G-Code (`;Slicer info:<key>;<Displayname>;<Value>`). You can add as much metadata as you like. Actually only the first 5000 rows are read after upload.
